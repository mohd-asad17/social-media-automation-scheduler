      ...
      <nav className="flex-1 px-3 space-y-1">
       {navItems.map((item) => {
        ...
        return (
            ...
            onClick={()=> setIsOpen(false)} className={`flex items-center gap-3 px-3 py-2.5 rounded text-sm transition-all duration-150 border ${isActive ? "bg-red-50 text-red-600 border-red-100" : 
