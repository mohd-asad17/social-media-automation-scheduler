  ...
  try {
    ...
    if (generateImage) {
      try {
        ...
        if (leonardoKey) {
          // Use leonardo.ai for image generations
          ...
          const generationId = leonardoResponse.data.generate.generationId;
...
export const schedulePost = async (
  ...
  res: Response,
    ...
    try {
        ...
        // Parse platforms if it comes as a strigified array from FormData
        ...
        let mediaUrl: string | null = req.body.mediaUrl;
        let mediaType: "image" | "video" | null = req.body.mediaType;
